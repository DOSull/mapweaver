...
def _(centred, mo):
    mo.vstack([mo.image(src="mw.png").style(centred),
               mo.md(f"<p style='font-style:italic;text-align:center;line-height:1.2em;'><span title='Weaving maps of complex data'>2025.08.10 built with <a href='https://github.com/DOSull/weaving-space' target='_blank'>weavingspace 0.0.7.7</a></span></p>")]).center()
    return
